...
\footnote{\tiny URL: https://groups.google.com/forum/\#!forum/utm-wg} % Your email address
\footnote{\tiny Email List: utm-wg@googlegroups.com} % Your email address
}
...
*+{\txt{NPNT}} \ar[r] & *+[F--]{\txt{Remote ID}} \ar[l] \ar[r] & *+[F]{\txt{UTM}} \ar[l] \ar[r] & *+{\txt{Risk}} \ar[l] \ar[r] & *+{\txt{Deconfliction}} \ar[l] }
\hfil \end{center}
\par\end{centering}
\caption{A few Working and Research Groups}
\end{figure}
